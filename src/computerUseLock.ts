/**
 * Cross-process Computer-Use lock — platform-agnostic.
 *
 * Original: Claude Code src/utils/computerUse/computerUseLock.ts
 * Uses Node.js O_EXCL (flag:'wx') which maps to CreateFileW(CREATE_NEW) on
 * Windows, so this works identically on macOS, Linux and Windows.
 */
